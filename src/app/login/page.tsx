    ...
    <>
      <div className="flex flex-row justify-between items-center m-30">
        <div className="flex flex-col">
          ...
          <div className="mt-5">
            <button
              className="w-94 h-13 bg-principal text-background font-semibold size-22 rounded-xl hover:bg-roxo-claro hover:text-white cursor-pointer"
              type="button"
          ...
          <div className="w-93 mt-3 flex flex-row">
            ...
            <a href="#" className="ml-1 font-semibold text-principal">
              Cadastre-se
            </a>
          </div>
        </div>
